...
// k.loadSpriteAtlas("sprites/001.png", {
// 	"bul": {
// 		x: 0,
// 		y: 0,
// 		width: 64,
...
function interact() {
	const pointerPosition = k.mousePos();
	const pointerPositionX = k.mousePos().x
	const pointerPositionY = k.mousePos().y

	debug.log('player Pos: ' + player.pos + ' MousePos: ' + pointerPosition)

	// let interacted = false
	// player.moveTo(pointerPosition);
	// debug.log(vector)
...
onMouseMove((action) => {
	debug.log('mousePos: ' + action + 'playerPos: ' + player.pos);
})
